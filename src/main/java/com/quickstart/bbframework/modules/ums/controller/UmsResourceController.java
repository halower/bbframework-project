...
import com.quickstart.bbframework.modules.ums.service.UmsResourceService;
import com.quickstart.bbframework.security.component.DynamicSecurityMetadataSource;
...
public class UmsResourceController {
    ...
    @ResponseBody
    public JsonResult<UmsResource> getItem(@PathVariable Long id) {
    ...
    @ResponseBody
    public JsonResult<CommonPage<UmsResource>> list(@RequestParam(required = false) Long categoryId,
