...
public class UmsRoleController {
    ...
    @ResponseBody
    public JsonResult<CommonPage<UmsRole>> list(@RequestParam(value = "keyword", required = false) String keyword,
    ...
    @ResponseBody
    public JsonResult<List<UmsMenu>> listMenu(@PathVariable Long roleId) {
    ...
    @ResponseBody
    public JsonResult<List<UmsResource>> listResource(@PathVariable Long roleId) {
